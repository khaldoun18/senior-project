  ...
  <div class="card-container">
    ...
    <div class="card-wrapper">
      <div class="card">
        <div class="card-body">
          <center>
            <h4 class="card-title"><?php echo $row['price'];?>$</h4><br><hr>
          </center>
          <p class="card-text">In this package we offer <?php echo $row['sessions'];?> sessions</p><br><br><hr>
      ...
      <div class="button-container">
        <form method="post" action="packageManage.php">
          <div class="hidden">
            ...
            <input type="hidden" name="package_description" value="<?php echo $row['package_description']; ?>">
          </div>
          <button type="submit" name="submit" class="btn btn-primary">manage</button>
        </form>
        <form method="post" action="deletePackage.php">
          <input type="hidden" name="package_id" value="<?php echo $row['package_id']; ?>"><br>
